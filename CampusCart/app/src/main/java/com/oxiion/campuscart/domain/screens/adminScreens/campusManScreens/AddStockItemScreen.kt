...
fun AddStockItemScreen(
    ...
    val addStockItemState by campusManViewModel.addStockItemState.collectAsState()
        ...
        Column(
            ...
            CustomButton("Add Product") {
                if (productName.value.isBlank() ||
                    ...
                    campusManViewModel.addProductWithImage(
                        imageUri!!,
                        product,
    ...
    when (addStockItemState) {
        is StateData.Error -> {
            isLoading.value = false
            Toast.makeText(
                context,
                (addStockItemState as LoginState.Error).message ?: "Unknown Error",
                Toast.LENGTH_LONG
            ).show()
            campusManViewModel.resetAddStockItemState()
        }
